...
class ParallelRunner:
    ...
    def __init__(self, args, logger):
        ...
        if args.wandb:
            ...
            wandb.init(project=args.project_name, name=args.wandb_name, group=map_name, job_type=job_type, config=args)
    ...
    def reset(self):
        ...
        for parent_conn in self.parent_conns:
            ...
            pre_transition_data["all_node"].append(data["all_node"])
            pre_transition_data["all_adj"].append(data["all_adj"])
            pre_transition_data["ene_node"].append(data["ene_node"])
            pre_transition_data["ene_adj"].append(data["ene_adj"])
...
def env_worker(remote, env_fn):
    ...
    while True:
        ...
        if cmd == "step":
            ...
            obs = env.get_obs()
            all_node = env.get_graph_ally_node(),
            all_adj = env.get_graph_ally_edge(),
            ene_node = env.get_graph_enemy_node(),
            ene_adj = env.get_graph_enemy_edge(),
