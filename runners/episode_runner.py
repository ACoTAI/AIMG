...
class EpisodeRunner:
    ...
    def __init__(self, args, logger):
        ...
        if args.wandb:
            job_type = args.label
            # wandb_name = args.wandb_name#f'seed_{args.seed}_{args.label}'
    ...
    def get_env_info(self):
        ...
        env_info['extra_inf_size'] = self.env.extrin_shape
        env_info['n_enemies'], env_info['ally_size'], env_info['extrin_env_size'] = self.env.get_extrin_env_size()
    ...
    def run(self, test_mode=False):
        ...
        while not terminated:
            ...
            pre_transition_data = {
                ...
                "extrinsic_state": [self.env.get_extrinsic_state()],
        ...
        if test_mode and (len(self.test_returns) == self.args.test_nepisode):
            ...
            if self.args.wandb:
                wandb.log({'step': self.t_env, 'Test_win_rate':win_rate, log_prefix + "return_mean": reward,
                           log_prefix + "return_std": np.std(cur_returns)})
